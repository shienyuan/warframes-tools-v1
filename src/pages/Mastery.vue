<template>
    <Layout>
        <template v-slot:header> Mastery Calculator </template>
...
export default {
    ...
    components: {
        rank: () => import('~/components/mastery/Rank'),
        recommends: () => import('~/components/mastery/Recommends'),
        rankSelector: () => import('~/components/mastery/RankSelector'),
        MpRequirement: () => import('~/components/mastery/MpRequirement'),
    },
    created() {},
    data() {
        return {
